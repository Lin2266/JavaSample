...
public class Scanner2 {
    ...
    public static void main(String[] args) throws IOException {
            FileWriter fw=new FileWriter("F:\\JAVA_C\\eclipse-jee-2018-09-win32-x86_64\\專案\\JavaSample\\src/Stock.txt");
            fw.write("2330,台積電,50.5,10#2303,聯電,21,20,結束");
            fw.close();
            
            FileReader fr=new FileReader("F:\\JAVA_C\\eclipse-jee-2018-09-win32-x86_64\\專案\\JavaSample\\src/Stock.txt");   
