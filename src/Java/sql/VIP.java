...
public class VIP extends Customer{
    ...
    public VIP(String id, String name,String password, char gender, String email) {
        super(id, name, password, gender, email);
    }

    public VIP(int discount, String id, String name, String password, char gender, String email) {
        super(id, name, password, gender, email);
