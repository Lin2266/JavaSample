...
public class Excel_CreateSheet {

	public static void main(String[] args) throws Exception{
		//建立xlsx跟xls檔案，建立1張及多張工作表
		try {
			XSSFWorkbook xlsx = new XSSFWorkbook();
			FileOutputStream out_xlsx = new FileOutputStream(new File("src/LIN/employee1.xlsx"));
			FileOutputStream out_xls = new FileOutputStream(new File("src/LIN/employee1.xls"));
